...
function renderSimulationReportHtml(projectName, generatedFiles) {
...
function writeSimulationReportHtml(targetPath, projectName, generatedFiles) {
  const abs = path.resolve(targetPath);
  fs.mkdirSync(path.dirname(abs), { recursive: true });
  fs.writeFileSync(abs, renderSimulationReportHtml(projectName, generatedFiles), "utf8");
  return abs;
}

module.exports = {
  renderSimulationReportHtml,
  writeSimulationReportHtml,
};
