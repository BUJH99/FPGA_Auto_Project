...
const srcFileList = (manifestContext.srcFiles || [])
    .filter((p) => /\.(v|sv)$/i.test(p))
    .sort((a, b) => a.localeCompare(b));
const tbFileList = (manifestContext.tbFiles || [])
    .filter((p) => /\.(v|sv)$/i.test(p))
    .sort((a, b) => a.localeCompare(b));
...
const includeDirs = (manifestContext.incDirs || []).sort((a, b) => a.localeCompare(b));
