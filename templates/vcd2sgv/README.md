...
```bat
python templates\vcd2sgv\vcd2svg.py Sensor_Uart\output\iverilog\vcd\tb_dht11_controller.vcd out.svg --list-signals
```
...
```bat
python templates\vcd2sgv\vcd2wavedrom.py ^
  Sensor_Uart\output\iverilog\vcd\tb_dht11_controller.vcd ^
...
`templates/contexts/simulation/adapters/bat/sim_convert_vcd_svg.bat` now launches `vcd2svg_interactive.py`.
...
`templates/contexts/simulation/adapters/bat/sim_convert_vcd_wavedrom.bat` launches `vcd2wavedrom_interactive.py`.
